...
class StateMachine:
    ...
    def take_damage(self):
        """Recibir daño, si la vida llega a 0, pasa a estado 'Muerto'."""
        if self.dead:
...
def draw_character(state, x, y, direction):
    """Dibuja la figura geométrica correspondiente al estado"""
    if state == "Reposo":
        pygame.draw.rect(screen, (0, 255, 0), (x, y, 50, 50))
    elif state == "Caminando":
        if direction == "right":
            points = [(x, y + 50), (x + 50, y + 25), (x, y)]
        else:
            points = [(x + 50, y + 50), (x, y + 25), (x + 50, y)]
        pygame.draw.polygon(screen, (0, 0, 255), points)
    elif state == "Saltando":
        points = [(x + 25, y), (x, y + 50), (x + 50, y + 50)]
        pygame.draw.polygon(screen, (255, 255, 0), points)
    elif state == "Atacando":
        pygame.draw.circle(screen, (255, 0, 255), (x + 25, y + 25), 25)
    elif state == "Dañado":
        pygame.draw.line(screen, (255, 0, 0), (x, y), (x + 50, y + 50), 5)
        pygame.draw.line(screen, (255, 0, 0), (x + 50, y), (x, y + 50), 5)
    elif state == "Muerto":
        pygame.draw.line(screen, (0, 0, 0), (x + 10, y + 10), (x + 40, y + 40), 5)
        pygame.draw.line(screen, (0, 0, 0), (x + 40, y + 10), (x + 10, y + 40), 5)
...
while running:
    ...
    draw_character(personaje.current_state.name, x, y, direction)
